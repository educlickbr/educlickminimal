-- ============================================================
-- Migration: fix_lms_list_curriculo_order_by
-- Data: 2026-07-27
-- Descrição: Corrige referências a c.titulo, c2.titulo, c3.titulo
--            nos ORDER BY internos do lms_list_curriculo.
--            Essas tabelas não existem no escopo do jsonb_agg
--            externo — devem referenciar os aliases da subquery.
-- ============================================================

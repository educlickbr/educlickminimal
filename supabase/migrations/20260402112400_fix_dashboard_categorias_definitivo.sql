-- Nova migration definitiva para corrigir a RPC fin_get_dashboard_categorias com base na estrutura real das tabelas.
-- Removendo colunas inexistentes: cor, icone.
...
DECLARE
    ...
    v_matriz JSON;
BEGIN
    -- 1. TOP 3 (ou filtro único) vs Média Histórica de Despesas (Últimos 6 meses)

-- ============================================================
-- Migration: 20260713100034 — Fix public functions to DEFINER
-- ============================================================
-- Funções públicas (chamadas sem login) PRECISAM ser DEFINER
-- porque a RLS bloqueia operações de anon.
--
-- Regra geral:
--   Autenticado  → INVOKER (RLS protege)
--   Público      → DEFINER (bypassa RLS)
-- ============================================================

-- a) Inscrição em edital (página pública)
...
-- b) Verificar email (tela de login)

-- MIGRATION: Cria RPC específico para top 3 despesas de contas por período
-- Data: 2026-03-23

DROP FUNCTION IF EXISTS public.fin_get_top_contas_periodo(uuid, text, text, integer);
CREATE OR REPLACE FUNCTION public.fin_get_top_contas_periodo(
  p_id_entidade uuid,
  p_data_inicio text,
  p_data_fim text,
...
GRANT EXECUTE ON FUNCTION public.fin_get_top_contas_periodo(uuid, text, text, integer) TO authenticated, service_role;

-- ============================================================
-- Migration: 20260724000013 — fix aca_get_modulos_componentes
-- Descrição: Muda para SECURITY DEFINER porque o JOIN com
--            user_expandido (para buscar docente_nome) falha
--            com o RLS "ver apenas o próprio".
-- ============================================================
            ...
            'componentes', (
                SELECT jsonb_agg(
                    jsonb_build_object(
                        ...
                        'componente_nome', COALESCE(c.nome_componente, c.nome),
                    ...
                    ) ORDER BY mc.ordem, COALESCE(c.nome_componente, c.nome)
                )

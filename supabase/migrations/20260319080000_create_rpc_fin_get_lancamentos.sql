-- MIGRATION: Cria RPC para listagem de lançamentos com filtros
-- Data: 2026-03-19
...
GRANT EXECUTE ON FUNCTION public.fin_get_lancamentos(uuid, uuid, uuid, date, date, boolean) TO authenticated;
GRANT EXECUTE ON FUNCTION public.fin_get_lancamentos(uuid, uuid, uuid, date, date, boolean) TO service_role;

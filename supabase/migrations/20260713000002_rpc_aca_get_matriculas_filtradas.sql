-- ============================================================
-- Migration: RPC aca_get_matriculas_filtradas
-- Data: 2026-07-13
-- Descrição: Retorna matrículas da entidade com dados do aluno,
--            programa, área, turma e foto. Filtros por área,
--            ano/semestre, turma, status e busca textual.
--            Com paginação.
-- ============================================================

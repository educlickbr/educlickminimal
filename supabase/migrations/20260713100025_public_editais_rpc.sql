-- ============================================================
-- Migration: 20260713100033 — Public RPC for editais
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.aca_get_editais_publicos(UUID) TO anon, authenticated;

-- ============================================================
-- Corrige auth_verificar_email: DEFINER + anon
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.auth_verificar_email(TEXT) TO anon, authenticated;

-- ============================================================
-- Corrige aca_inscrever_edital_publico: DEFINER + anon
-- ============================================================
...
REVOKE ALL ON FUNCTION public.aca_inscrever_edital_publico(UUID, UUID, TEXT, TEXT, JSONB) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.aca_inscrever_edital_publico(UUID, UUID, TEXT, TEXT, JSONB) TO anon, authenticated;

-- ============================================================
-- Migration: fix_lms_list_curriculo_componentes_filter
-- Data: 2026-07-27
-- Descrição: Filtra componentes no lms_list_curriculo para
--            mostrar apenas aqueles vinculados ao curso do
--            programa (via aca_modulo_componente → aca_curso_modulo).
--            Antes trazia TODOS os componentes da entidade.
-- ============================================================
...
BEGIN
    ...
    -- Filtra apenas componentes vinculados ao curso do programa

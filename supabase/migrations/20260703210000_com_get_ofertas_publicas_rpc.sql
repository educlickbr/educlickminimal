-- ============================================================
-- Migration: com_get_ofertas_publicas_rpc
-- Data: 2026-07-03
-- Descrição: RPC pública que retorna ofertas ativas com
--            dados do produto, programa e curso
-- ============================================================
...
BEGIN
    WITH ofertas_base AS (
        SELECT
            ...
            -- Processo seletivo ativo (se houver)

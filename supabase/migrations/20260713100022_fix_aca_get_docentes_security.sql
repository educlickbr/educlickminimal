-- ============================================================
-- Migration: 20260713100022 — Fix aca_get_docentes SECURITY
-- ============================================================
-- A RPC aca_get_docentes precisa ser SECURITY DEFINER
-- porque a RLS de user_expandido bloqueia JOINs.
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.aca_get_docentes(UUID, TEXT, INTEGER, INTEGER) TO authenticated;

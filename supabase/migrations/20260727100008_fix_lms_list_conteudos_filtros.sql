-- ============================================================
-- RPC: atualiza lms_list_conteudos com filtro por criador
-- Data: 2026-07-27
-- Descrição: Adiciona p_criado_por para filtrar "feito por mim"
-- ============================================================

DROP FUNCTION IF EXISTS public.lms_list_conteudos(p_id_entidade uuid, p_pagina integer, p_limite integer, p_busca text, p_tipo text);

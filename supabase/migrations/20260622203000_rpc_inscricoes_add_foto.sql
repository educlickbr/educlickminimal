-- ============================================================
-- RPC: aca_get_inscricoes_filtradas (v2 — adiciona id_foto)
-- Data: 2026-06-22
-- Descrição: Adiciona o id_foto (resposta à pergunta global
--            "sua_foto") via aca_resposta_form → global_arquivos.
-- ============================================================

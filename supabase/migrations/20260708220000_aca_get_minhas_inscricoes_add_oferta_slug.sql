-- ============================================================
-- Fix RPC: aca_get_minhas_inscricoes — adiciona oferta_slug
-- para o botão "Matricular" redirecionar ao checkout
-- ============================================================
...
BEGIN
    ...
    SELECT jsonb_agg(sub ORDER BY sub.data_inscricao DESC)
    INTO v_itens
    FROM (
        SELECT

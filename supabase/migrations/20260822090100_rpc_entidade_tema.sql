-- ======================================================
-- Expõe o tema da entidade nas RPCs de sessão (item 2)
-- Adiciona 'tema' ao objeto branding retornado por:
--   - app_resolver_entidade_por_dominio
--   - app_get_minha_sessao (entidades + entidade_ativa)
-- A coluna user_entidades.tema vem da migration 20260822090000.
-- ======================================================

-- 1. app_resolver_entidade_por_dominio (recria) — acrescenta tema
...
-- 2. app_get_minha_sessao (recria) — acrescenta tema no branding
...
BEGIN
    ...
    RETURN jsonb_build_object(
        ...
        'tema', COALESCE(v_entidade->>'tema', 'dark')
    );
END;
$$;

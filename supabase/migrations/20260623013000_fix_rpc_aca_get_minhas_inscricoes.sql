-- ============================================================
-- Fix RPC: aca_get_minhas_inscricoes — corrige ORDER BY
-- Data: 2026-06-23
-- Descrição: A subquery renomeia criado_em → data_inscricao,
--            mas o jsonb_agg externo referenciava sub.criado_em
--            que não existe. Corrigido para sub.data_inscricao.
-- ============================================================

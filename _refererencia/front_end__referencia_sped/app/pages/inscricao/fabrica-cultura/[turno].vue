...
const courseId =
    turnoParam === "matutino"
        ? "8331bcbb-4c8c-4cea-ab12-b7fa28833a84"
        : turnoParam === "vespertino"
          ? "d9d321dd-4009-4ac3-9541-c616b68ba54b"
          : (() => {
                throw createError({
                    statusCode: 404,
                    statusMessage:
                        "Turno invalido para inscricao de Fabrica de Cultura.",
                });
            })();

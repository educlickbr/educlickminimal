            ...
            >
                <div>
                    ...
                    <p class="text-sm text-secondary mt-1">
                        Selecione como deseja que o nome apareça
                        {{ actionLabel }}.
                    </p>
                </div>
                <button
...
import type { OpcaoNomeImpressao } from "~/composables/avaliacoes-alunos/useAvaliacoesAlunosNome"
...
defineEmits<{
    close: []
    confirm: [opcao: OpcaoNomeImpressao]
}>()
</script>

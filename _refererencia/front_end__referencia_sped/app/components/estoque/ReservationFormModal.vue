...
const handleSubmit = () => {
    ...
    emit("save", {
        ...
        data_retirada: new Date(
            form.value.data_retirada || new Date(),
        ).toISOString(),
...
<template>
    ...
    >
        ...
        ></div>
        <div
            class="bg-[#16161E] border border-white/10 rounded-xl w-full max-w-md p-6 relative z-10 shadow-2xl"
        >
            <h3
                ...
                <div class="space-y-2">
                    ...
                    <BaseSelect
                        ...
                        :options="
                            produtos.map((p) => ({
                                ...p,
                                label: `${p.nome} (Disp: ${p.total_estoque})`,
                                disabled: p.total_estoque <= 0,
                            }))
                        "
                        labelKey="label"
                        valueKey="id"

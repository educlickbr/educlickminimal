        ...
        if (newVal) {
            if (props.etapa) {
                form.value = {
                    ...
                    data_inicio: props.etapa.data_inicio
                        ? props.etapa.data_inicio.slice(0, 16)
                        : "",
                    data_fim: props.etapa.data_fim
                        ? props.etapa.data_fim.slice(0, 16)
                        : "",
                    ...
                    publicado_em: props.etapa.publicado_em
                        ? props.etapa.publicado_em.slice(0, 16)
                        : "",
                    desativado_em: props.etapa.desativado_em
                        ? props.etapa.desativado_em.slice(0, 16)
                        : "",
                };
            } else {
                form.value = {
...
const save = async () => {
    ...
    try {
        ...
        showToast("Etapa salva com sucesso!", { type: "success" });
        emit("saved");
        emit("close");
    } catch (e: any) {
        console.error(e);
        showToast(e.message || "Erro ao salvar etapa.", { type: "error" });
    } finally {
...
<template>
    ...
    >
        ...
        ></div>
        <div
            class="relative bg-[#1a1b26] w-full max-w-2xl rounded-xl border border-white/10 p-6 shadow-2xl max-h-[90vh] overflow-y-auto"
        >
                ...
                <div class="space-y-1">
                    ...
                    >
                        ...
                        >
                            ...
                            <p
                                class="text-[10px] font-bold text-green-400 truncate max-w-full px-4"
                            >

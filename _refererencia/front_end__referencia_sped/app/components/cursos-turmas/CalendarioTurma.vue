...
const { saveEvento, deleteEvento } = useCursosTurmasModalAula();
...
const confirmDelete = async () => {
    ...
    try {
        const response: any = await deleteEvento(eventToDelete.value.id);
...
<template>
    <div class="calendar-wrapper w-full relative">
        ...
        <ConfirmationModal
            ...
            :message="
                eventToDelete
                    ? `Deseja realmente remover o evento '${eventToDelete.title}'?`

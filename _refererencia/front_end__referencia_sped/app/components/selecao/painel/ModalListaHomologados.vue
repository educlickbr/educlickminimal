...
const saveParams = async (turma: any) => {
    turma.isSaving = true;
    try {
        const endpoint = "/api/selecao/parametros-homologacao" as string;
...
const generateBody = (items: any[]) => {
    ...
    Qualquer dúvida, escreva para secretaria.sped@prodanca.org.br ou pelo telefone: (11) 91593-2046.
    `;
    ...
    const blocoCabecalhoInstitucional = () => `
        <div class="cabecalho-interno">
          ...
          <div class="texto-etapas">
            As Etapas I e II acontecerão <strong>${config.value.dataEtapas}</strong> ${textoEndereco}
          </div>
        </div>
    `;
                                ...
                                >
                                    <div class="md:col-span-2">
                                        <label
                                            ...
                                            >Título Central 1 (Prefixo)</label
                                        >
                                        <input
                                            v-model="config.tituloCentral_1"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        >
                                        <input
                                            v-model="config.tituloCentral_2"
                                            class="w-full bg-[#0f0f15] border border-white/10 rounded px-3 py-2 text-sm text-white focus:border-primary focus:outline-none"
                                        />
                                    </div>
                                    <div class="md:col-span-2">
                                        <label
                                            class="block text-xs font-bold text-secondary mb-1"
                                            >Título Central 3 (Subtítulo)</label
                                        >
                                        <input
                                            v-model="config.tituloCentral_3"
                                            class="w-full bg-[#0f0f15] border border-white/10 rounded px-3 py-2 text-sm text-white focus:border-primary focus:outline-none"
                                        />
                                    </div>
                                    <div class="md:col-span-2">
                                        <label
                                            class="block text-xs font-bold text-secondary mb-1"
                                            >Texto da Data das Etapas</label
                                        >
                                        <input
                                            v-model="config.dataEtapas"
                                            type="text"
                                            class="w-full bg-[#0f0f15] border border-white/10 rounded px-3 py-2 text-sm text-white focus:border-primary focus:outline-none"
                                        />
                                        <p
                                            class="text-[10px] text-secondary mt-1"
                                        >
                                            Ex: dia 01 a 03/12/2025
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                >
                                    <div class="space-y-1 mt-4">
                                        ...
                                        <div
                                            ...
                                            "
                                            class="text-xs text-secondary/50 italic py-2"
                                        >

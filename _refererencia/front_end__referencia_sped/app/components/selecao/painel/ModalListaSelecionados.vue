...
const generateBody = (items: any[]) => {
    const logoUrl =
        "https://spedppull.b-cdn.net/site/sped_logo_total%20(1).png";
...
<template>
    <div v-if="isOpen" class="relative z-50">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            ...
            >
                <div
                    class="relative w-full max-w-4xl transform overflow-hidden rounded-2xl bg-[#1A1B26] text-left align-middle shadow-xl transition-all border border-white/10 flex flex-col max-h-[90vh]"
                >
                    <!-- Header -->
                    <div
                    ...
                    <!-- Content -->
                    <div
                        class="p-6 bg-[#1A1B26] overflow-y-auto custom-scrollbar flex-1"
                    >
                        <div
                            v-if="isLoading"
                        ...
                        <div v-else>
                            ...
                            >
                                <div
                                    class="bg-white/5 rounded-lg p-5 border border-white/5"
                                >
                                    <label
                                        class="block text-xs font-bold text-secondary uppercase mb-2"
                                        >Semestre e Módulo</label
                                    >
                                    <p
                                        class="text-[10px] text-secondary/50 mb-2"
                                    >
                                        Complementa a frase: "...dos Cursos
                                        Regulares do [TEXTO]"
                                    </p>
                                    <input
                                ...
                                >
                                    <label
                                        class="block text-xs font-bold text-secondary uppercase mb-2"
                                        >Período de Matrícula</label
                                    >
                                    <p
                                        class="text-[10px] text-secondary/50 mb-2"
                                    >
                                        Complementa a frase: "Período de
                                        matrícula on-line: [TEXTO]"
                                    </p>
                                    <input
                                ...
                                <div
                                    class="flex p-4 mb-4 text-sm text-yellow-500 rounded-lg bg-yellow-500/10 border border-yellow-500/20"
                                    role="alert"
                                >
                                    <svg
                                    ...
                                    <div>
                                        <span class="font-medium"
                                            >Atenção:</span
                                        >
                                        Estes textos são usados apenas para a
                                        impressão e não são salvos no banco de
                                        dados. Configure antes de imprimir.
                                    </div>
                                </div>
                            </div>
                                    ...
                                    >
                                        <div class="space-y-1 mt-4">
                                            <div
                                                ...
                                                :key="idx"
                                                class="flex gap-3 text-sm text-secondary-300 py-1 border-b border-white/5 last:border-0 pl-4"
                                            >
                                                <span

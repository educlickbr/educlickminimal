...
export default defineEventHandler(async (event) => {
    // 1. Auth Check (Any authenticated user can upload - e.g. student)
    ...
    // User requested "editais" folder
    const normalizedPath = "editais";

    // Ensure filename is safe (this encodes / so subfolders via filename won't work standardly)
    // If the frontend sends "123/file.pdf", it becomes "123%2Ffile.pdf" (flat file)

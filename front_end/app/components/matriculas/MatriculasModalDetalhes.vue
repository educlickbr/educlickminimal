...
watch(
    ...
    async (aberto) => {
        ...
        try {
            const res = (await $fetch("/api/matriculas/detalhes", {
                params: { id_matricula: props.idMatricula },
            })) as any;
                ...
                <template v-else-if="dados">
                    ...
                    >
                        ...
                        <div class="flex flex-col gap-1 items-end">
                            ...
                            <span
                                class="text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded border"
                                :class="
                                    statusBadgeClass(dados.matricula?.status)
                                "
                            >
                    ...
                    <template v-if="dados.blocos?.length">
                        <!-- Tabs dos blocos -->
                        <div

    ...
    <div v-if="modelValue" class="modal-overlay" @click.self="fechar">
        <div class="modal-panel">
            ...
            <div class="modal-body p-6 flex flex-col gap-4">
                <div>
                    <label
                        class="block text-xs font-bold text-secondary/60 mb-1"
                        >Título/Label da Pergunta
                ...
                <div>
                    <label
                        class="block text-xs font-bold text-secondary/60 mb-1"
                        >Placeholder (Texto de Ajuda)</label
                    >
                    <input
                ...
                <div
                    ...
                    "
                    class="bg-[#8b5cf6]/5 border border-[#8b5cf6]/20 p-4 rounded-xl"
                >
                    ...
                    <div
                        ...
                        class="text-xs text-secondary/40 italic text-center py-2"
                    >
                    ...
                    >
                        ...
                        >
                            <input
                                ...
                                class="flex-1 text-xs p-2 rounded bg-black/30 border border-white/10 text-white focus:outline-none focus:border-primary/50"
                            />
                            <button
                                @click="removeOption(idx)"
                                type="button"
                                class="text-red-400 hover:text-red-300 w-6 h-6 flex items-center justify-center bg-red-400/10 rounded"
                            >
                                &times;
                            </button>
                        </div>
            ...
            <div class="modal-footer">
                <button @click="fechar" class="modal-btn-cancel">
                    Cancelar
                </button>
                <button
                    @click="salvar"

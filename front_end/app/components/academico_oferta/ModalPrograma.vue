        ...
        <div class="modal-panel modal-panel--lg">
            ...
            >
                ...
                <div
                    ...
                    class="flex flex-col gap-6 animate-in fade-in zoom-in-95 duration-300"
                >
                    <div class="flex flex-col gap-2 mb-2">
                        <h4
                            class="text-sm font-black text-primary uppercase tracking-widest"
                        >
                            Qual a base desta oferta?
                        </h4>
                        <p class="text-xs text-secondary/60">
                            Escolha se deseja ofertar um Curso completo ou
                            apenas um Módulo/Ciclo avulso.
                        </p>
                    </div>
                        ...
                        <button
                            ...
                            :class="
                                form.origem === 'curso'
                                    ...
                                    : 'border-secondary/10 bg-div-5 hover:border-primary/50'
                            "
                        >
                            <div
                                ...
                                :class="
                                    form.origem === 'curso'
                                        ...
                                        : 'bg-secondary/10 text-secondary/40 group-hover:text-primary'
                                "
                            >
                                <Icon
                            ...
                            <h5
                                class="text-sm font-black text-primary mb-1 uppercase tracking-widest"
                            >
                                A partir de um Curso
                            </h5>
                            <p
                                class="text-[11px] text-secondary/60 leading-relaxed"
                            >
                                Analisa a matriz do curso e agrupa múltiplos
                                ciclos numa trilha completa de formação.
                            </p>
                            <div
                                v-if="form.origem === 'curso'"
                        ...
                        <button
                            ...
                            :class="
                                form.origem === 'ciclo'
                                    ...
                                    : 'border-secondary/10 bg-div-5 hover:border-orange-500/50'
                            "
                        >
                            <div
                                class="w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors"
                                :class="
                                    form.origem === 'ciclo'
                                        ...
                                        : 'bg-secondary/10 text-secondary/40 group-hover:text-orange-500'
                                "
                            >
                                <Icon name="ph:books-bold" class="w-6 h-6" />
                            </div>
                            <h5
                                class="text-sm font-black text-orange-500 mb-1 uppercase tracking-widest"
                            >
                                A partir de Ciclos
                            </h5>
                            <p
                                class="text-[11px] text-secondary/60 leading-relaxed"
                            >
                                Ideal para ofertas avulsas, cursos rápidos ou
                                extensões que dependam da escolha livre de
                                ciclos programados.
                            </p>
                            <div
                                v-if="form.origem === 'ciclo'"
                                class="absolute top-4 right-4 text-orange-500"
                            >
                                <Icon
                                    name="ph:check-circle-fill"
                                    class="w-6 h-6"
                ...
                >
                    ...
                    <div
                        v-if="loadingCiclos"
                        class="py-8 flex flex-col items-center justify-center text-secondary/40"
                    >
                        <Icon
                        ...
                        <span
                            ...
                            >Buscando ciclos disponíveis...</span
                        >
                    </div>

                    <div
                        v-else-if="ciclosEncontrados.length > 0"
                    ...
                    >
                            ...
                            >
                                <div class="flex items-start gap-4">
                                    ...
                                    >
                                        ...
                                        <p
                                            class="text-[10px] font-bold text-secondary/60"
                                        >
                                            {{
                                                ciclo.descricao ||
                                                "Sem descrição"
                                        ...
                                        <div
                                            class="flex items-center gap-4 mt-2 pt-2 border-t border-secondary/5 text-[9px] font-bold uppercase tracking-widest text-secondary/40"
                                        >
                                            <span
                        ...
                        <div
                            v-if="
                                form.origem === 'curso' &&
                                modulosPendentesCurso.length > 0
                            "
                            class="p-4 rounded-xl bg-orange-500/10 border border-orange-500/20 flex gap-3 items-start"
                        >
                            <Icon
                            ...
                            <div class="flex flex-col gap-1">
                                <span
                                    ...
                                    >Matriz Incompleta</span
                                >
                                <p
                                    class="text-[10px] text-orange-500/80 leading-relaxed"
                                >
                                    Existem módulos deste curso que não possuem
                                    nenhum ciclo disponível programado. Você
                                    pode continuar com os que estão aí, mas a
                                    oferta gerada não cobrirá a matriz por
                                    inteiro.
                                </p>
                            </div>
                        </div>
                    ...
                    <div
                        v-else-if="
                            (form.origem === 'curso' && form.id_curso) ||
                            form.origem === 'ciclo'
                        "
                    ...
                    >
                        Nenhum ciclo programado foi encontrado.<br />Vá para o
                        calendário e agende um ciclo primeiro.
                    </div>
                </div>
                ...
                <div
                    v-if="activeStep === 2"
                    class="flex flex-col gap-8 animate-in fade-in zoom-in-95 duration-300"
                >
                    <div class="flex flex-col gap-2">
                        <h4
                            class="text-sm font-black text-primary uppercase tracking-widest"
                        ...
                        <p class="text-xs text-secondary/60">
                            Cadastre uma ou mais janelas de seleção. Os períodos
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        >
                            {{ form.processos.length }} processo(s)
                            configurado(s)
                        </span>
                        <button
                    ...
                    <div
                        v-if="processosValidationMessage"
                    ...
                    >
                        ...
                        />
                        <p
                            class="text-[10px] text-emerald-500/90 leading-relaxed"
                        >
                            Regra ativa: um novo processo só pode iniciar quando
                            o anterior terminar (sem overlap).
                        </p>
                    </div>
                </div>
                ...
                >
                    <div
                        v-if="temOverlapping"
                        class="p-4 rounded-xl bg-red-500/10 border border-red-500/20 flex gap-3 items-start mb-2"
                    >
                        <Icon
                            name="ph:warning-octagon-fill"
                            class="w-5 h-5 text-red-500 shrink-0 mt-0.5"
                        ...
                        <div class="flex flex-col gap-1">
                            <span
                                ...
                                >Aviso de Calendário</span
                            >
                            <p
                                class="text-[10px] text-red-500/80 leading-relaxed"
                            >
                                Foram selecionados ciclos que ocorrem numa mesma
                                faixa de datas. Verifique se o agrupamento em
                                uma única oferta não gerará choque de horários
                                caso o aluno opte por eles simultaneamente.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        v-if="!isEdit && form.ciclos_selecionados.length > 1"
                    ...
                    >
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label
                                ...
                                :class="
                                    form.estrategia === 'unica'
                                        ? 'border-primary bg-primary/5'
                                        : 'border-secondary/10 bg-div-5 hover:border-primary/30'
                                "
                            >
                                <input
                                    type="radio"
                                ...
                                <div class="flex flex-col">
                                    <span
                                        class="text-xs font-black text-primary uppercase tracking-widest"
                                        >Oferta Única Integrada</span
                                    >
                                    <span class="text-[9px] text-secondary/60"
                                        >Gera 1 Programa englobando todos os
                                        ciclos selecionados.</span
                                    >
                                </div>
                            </label>
                            ...
                            <label
                                class="flex items-center gap-3 p-4 rounded-xl border-2 transition-colors cursor-pointer"
                                :class="
                                    form.estrategia === 'separada'
                                        ? 'border-orange-500 bg-orange-500/5'
                                        : 'border-secondary/10 bg-div-5 hover:border-orange-500/30'
                                "
                            >
                                <input
                                    type="radio"
                                ...
                                <div class="flex flex-col">
                                    <span
                                        class="text-xs font-black text-orange-500 uppercase tracking-widest"
                                        >Ofertas Múltiplas</span
                                    >
                                    <span class="text-[9px] text-secondary/60"
                                        >Gera
                                        {{ form.ciclos_selecionados.length }}
                                        Programas distintos, um para cada
                                        ciclo.</span
                                    >
                                </div>
                            </label>
                    ...
                    <div class="flex flex-col gap-4 mt-2">
                        <h4
                            class="text-[10px] font-black text-primary uppercase tracking-widest border-b border-secondary/10 pb-2"
                        >
                        ...
                        <div v-if="isEdit" class="flex flex-col gap-2">
                            ...
                            >
                                <option :value="null" disabled>
                                    Nenhum curso selecionado (Ciclo Isolado)
                                </option>
                                <option
                                    v-for="c in listCursos"
                                    :key="c.id"
                        ...
                        <div class="flex flex-col gap-2">
                            <label
                                class="text-[10px] font-black text-secondary/60 uppercase tracking-widest px-1"
                                >Área Acadêmica</label
                            >

                            <div
                                v-if="form.origem === 'curso'"
                                class="px-4 py-3 rounded-lg border border-secondary/10 bg-div-5 text-sm font-bold text-primary opacity-60"
                            >
                            ...
                            >
                                <option :value="null" disabled>
                                    Selecione a área para esta oferta
                                </option>
                                <option
                                    v-for="a in listAreas"
                                    :key="a.id"
                                    :value="a.id"
                                >
                                    {{ a.nome_area }}
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            >
                                {{
                                    form.estrategia === "separada" &&
                                    form.ciclos_selecionados.length > 1 &&
                                    !isEdit
                                        ? "Nomes Acadêmicos das Ofertas"
                                        : "Nome Acadêmico da Oferta / Programa"
                                }}
                            </label>
                            ...
                            >
                                <div
                                    v-for="cId in form.ciclos_selecionados"
                                    :key="cId"
                                    class="flex flex-col gap-1 p-3 rounded-lg border border-secondary/10 bg-div-5"
                                >
                                    <span
                                        class="text-[9px] font-black text-orange-500 uppercase tracking-widest flex items-center gap-1"
                                    >
                                        <Icon
                                            name="ph:arrow-elbow-down-right-bold"
                                        />
                                        {{
                                            ciclosEncontrados.find(
                                                (c) => c.id === cId,
                                            )?.modulo_nome || "Módulo"
                                        }}
                                    </span>
    ...
    try {
        ...
        if (res?.success && res.itens) {
            ciclosEncontrados.value = res.itens.map((c: any) => ({
                ...c,
                modulo_nome:
                    listModulos.value.find((m) => m.id === c.id_modulo)
                        ?.nome_modulo ||
...
const processosValidationMessage = computed(() => {
    ...
    for (let i = 0; i < form.processos.length; i++) {
        ...
        if (
            matriculaInicioMs !== null &&
            matriculaFimMs !== null &&
            matriculaFimMs < matriculaInicioMs
        ) {
...
const canSave = computed(() => {
    ...
    if (form.estrategia === "separada" && form.ciclos_selecionados.length > 1) {
        return (
            form.ciclos_selecionados.length > 0 &&
            form.ciclos_selecionados.every(
                (cId) =>
                    form.descricoes_multiplas[cId] &&
                    form.descricoes_multiplas[cId].trim().length > 0,
            )
        );
    }
    return (
    ...
    if (activeStep.value === 1) {
        ...
        if (form.estrategia === "separada" && !props.isEdit) {
            const cursoBase = listCursos.value.find(
                (c) => c.id === form.id_curso,
            );
            form.ciclos_selecionados.forEach((cId) => {
                if (!form.descricoes_multiplas[cId]) {
                    const cicloObj = ciclosEncontrados.value.find(
                        (c) => c.id === cId,
                    );
                    if (cicloObj) {
                        const nomeCursoStr = cursoBase
                            ? `${cursoBase.nome_curso} - `
                            : "";
                        const anoSemestreStr = cicloObj.ano_semestre
                            ? `${cicloObj.ano_semestre} - `
                            : "";
                        const moduloStr = cicloObj.modulo_nome || "Módulo";
                        form.descricoes_multiplas[cId] =
                            `${nomeCursoStr}${anoSemestreStr}${moduloStr}`;
                    }
                }
            });
        }
...
function checkOverlapping() {
    ...
    const selected = ciclosEncontrados.value.filter((c) =>
        form.ciclos_selecionados.includes(c.id),
    );
    temOverlapping.value = false;
...
async function handleSave() {
    ...
    try {
        ...
        const processosPayload = form.processos.map((processo, idx) => ({
            id: processo.id || null,
            nome_processo:
                processo.nome_processo?.trim() || `Processo ${idx + 1}`,
        ...
        if (props.isEdit) {
            const res = (await $fetch("/api/programas", {
                ...
                body: {
                    ...
                    processo_seletivo_inicio:
                        processoInicial?.data_inicio || null,
            ...
            if (res?.success) {
                toast.showToast("Programa salvo com sucesso!", {
                    type: "success",
                });
                emit("saved");
        ...
        if (res?.success) {
            toast.showToast("Programa(s) criado(s) com sucesso.", {
                type: "success",
            });
            emit("saved");
            emit("update:modelValue", false);
                ...
                try {
                    const [resCiclos, resProcessos] = await Promise.all([
                        $fetch("/api/programas/ciclos", {
                            params: { id_programa: props.programaId },
                        }) as any,
                    ...
                    if (
                        ...
                        form.processos = resProcessos.itens.map(
                            (p: any, idx: number) => ({
                                ...
                                matricula_inicio: formatToLocal(
                                    p.matricula_inicio,
                                ),
                        ...
                        fallback.nome_processo = props.initialData.descricao
                            ? `${props.initialData.descricao} - Processo`
                            : "Processo Seletivo";
                        fallback.data_inicio = formatToLocal(
                            props.initialData.processo_seletivo_inicio,
                        );
                        fallback.data_fim = formatToLocal(
                            props.initialData.processo_seletivo_fim,
                        );
                        fallback.matricula_inicio = formatToLocal(
                            props.initialData.matricula_inicio,
                        );
                        fallback.matricula_fim = formatToLocal(
                    ...
                    console.error(
                        "Erro ao buscar ciclos atrelados ao programa",
                        e,
                    );
                }
            } else {

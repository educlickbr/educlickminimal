<template>
  <div class="flex flex-col gap-6">
    ...
    <div
      ...
      class="ds-empty"
    >
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" class="text-secondary/25 mb-2">
...
.step-select:focus { border-color: var(--field-border-focus); }
...
.ciclo-item--selected .ciclo-checkbox-box {
  border-color: var(--color-primary); background: rgba(139,92,246,0.2); color: var(--color-primary);
}

.ciclo-info { display: flex; flex-direction: column; gap: 4px; flex: 1; min-width: 0; }
.ciclo-modulo { font-size: 12px; font-weight: 900; color: var(--color-text); }
.ciclo-desc { font-size: 11px; font-weight: 600; color: var(--color-secondary); }
.ciclo-periodo {

    ...
    <div class="flex flex-col gap-6">
        ...
        <div
            v-else-if="
                ...
                timelineMonths.every((m: any) => m.events.length === 0)
            "
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    >
                                        <span
                                            v-if="evt.recorrente_anual"
                                            class="px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest bg-primary/10 text-primary border border-primary/20"
                                            >Anual</span
                                        >
                                    </div>
                                </div>
        ...
        <GlobalModalConfirmacao
            ...
            :message="
                ctx.confirmTarget.value
                    ? `Excluir ${ctx.confirmTarget.value.nome}?`
                    : ''
            "
            type="danger"
            confirmText="Excluir"
            @confirm="ctx.deleteFeriado"
        />
    </div>
</template>

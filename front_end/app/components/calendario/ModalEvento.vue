    ...
    >
        <div class="modal-panel">
            ...
            <div class="modal-header">
                <div class="modal-header-icon text-violet-400">
                    ...
                    >
                        ...
                        ></path>
                        <path
                            d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm64-88a8,8,0,0,1-8,8H136v48a8,8,0,0,1-16,0V128a8,8,0,0,1,8-8h56A8,8,0,0,1,192,128Z"
                        ></path>
                    </svg>
                </div>
            ...
            <div class="p-6 flex flex-col gap-5">
                ...
                <!-- Previsto / Outcome -->
                <div
                    class="p-3 bg-secondary/5 rounded-lg border border-secondary/10 flex justify-between items-center"
                >
                    <span
                        class="text-[9px] font-black text-secondary uppercase tracking-widest"
                ...
                <!-- Flags -->
                <div
                    class="flex flex-col gap-3 p-4 bg-div-15 rounded-xl border border-secondary/5"
                >
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col gap-0.5">
                            ...
                            >
                            <span
                                class="text-[9px] text-secondary font-medium tracking-tight"
                        ...
                        >
                            ...
                            />
                            <div
                                class="w-10 h-5 bg-gray-200/10 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-primary"
                            ></div>
                        </label>
                    </div>
                </div>

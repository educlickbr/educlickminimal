                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center h-full gap-3 px-1">
                            ...
                            >
                                ...
                                />
                                <div
                                    class="w-11 h-6 bg-gray-200/10 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"
                                ></div>
                            </label>
                            <span
                                class="text-[10px] font-bold text-secondary uppercase tracking-tight"
                                >Recorrente Anual?</span
                            >
                        </div>
                    </div>
                </div>

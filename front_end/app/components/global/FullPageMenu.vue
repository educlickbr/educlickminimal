                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M17 21v-2a4 4 0 0 0-4-4H5c-1.1 0-2 .9-2 2v2"
                                    ></path>
                ...
                <div class="space-y-3">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="flex flex-col text-left">
                                <span
                                    class="text-sm font-bold text-text group-hover:text-emerald-500 transition-colors"
                                    >Produtos</span
                                >
                            </div>
                        </button>
                    ...
                    >
                        ...
                        >
                            <div class="menu-icon bg-sky-500/5 text-sky-400">
                                ...
                                >
                                    <path
                                        d="M22 8.5V12a10 10 0 1 1-20 0V8.5"
                                    ></path>
                                    <path
                                        d="M22 8.5C22 10.43 17.52 12 12 12S2 10.43 2 8.5"
                                    ></path>
                                    <path
                                        d="M2 8.5C2 6.57 6.48 5 12 5s10 1.57 10 3.5"
                                    ></path>
                                </svg>
                            </div>
                            <div class="flex flex-col text-left">

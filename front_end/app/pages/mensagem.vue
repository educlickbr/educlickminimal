...
<div class="min-h-screen flex items-center justify-center bg-[#0a0a0c] p-6 font-sans relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        <div class="bg-div-15 backdrop-blur-2xl border border-white/5 rounded-xl p-8 md:p-12 shadow-2xl text-center flex flex-col items-center gap-6">
            ...
            <button 
                @click="handleAction"
                class="mt-4 w-full bg-primary text-white font-black py-4 rounded-lg text-sm uppercase tracking-widest shadow-lg shadow-primary/20 hover:bg-primary-dark hover:shadow-primary/40 hover:-translate-y-0.5 transition-all active:scale-[0.98]"
            >
